...
namespace version04
{
    ...
    Socket::ptr Socket::CreateTCP(version04::Address::ptr address)
    {
        Socket::ptr sock(new Socket(address->getFamily(), TCP, 0));
        return sock;
    }

    Socket::ptr Socket::CreateUDP(version04::Address::ptr address)
    {
    ...
    bool Socket::getOption(int level, int option, void *result, socklen_t *len)
    {
        ...
        if (rt)
        {
            ...
            ULOG_DEBUG_SRC("main", "getOption sock={} level={} option={} errno={} errstr={}", m_sock, level, option, errno, strerror(errno));
            return false;
        }
        return true;
    }
    ...
    Socket::ptr Socket::accept()
    {
        ...
        if (newsock == -1)
        {
            ULOG_DEBUG_SRC("main", "accept sock={} errno={} errstr={}", m_sock, errno, strerror(errno));
            return nullptr;
        }
    ...
    {
        return IOManager::GetThis()->cancelEvent(m_sock, version04::IOManager::Event::READ);
    }

    bool Socket::cancelWrite()
    {
        return IOManager::GetThis()->cancelEvent(m_sock, version04::IOManager::Event::WRITE);
    }
